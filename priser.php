...
<main class="container priser px-4">
        ...
        <article class="row gx-2">
            ...
            <article class="main-text">
                <section data-bs-spy="scroll" data-bs-target="#simple-list-example" data-bs-offset="0"
                    ...
                    <h2 id="simple-list-item-1">Frontløberprisen</h2>
                    ...
                    <p>Grangia Erhvervspris hylder lokale talenter, under 40 år, der er særligt innovative og gode til
                        at
                        netværke. Prisen gives til personer der i særlig grad har markeret sig inden for sit felt og gør
                        en
                        positiv forskel for det lokale erhvervsliv, samt har placeret Slagelse på landkortet.</p>
                    <h2 id="simple-list-item-3">Initiativprisen</h2>
                    <p>Initiativprisen er en ganske særlig pris, som Slagelse Erhvervsråd uddeler til en virksomhed
                        eller
                        person i Slagelse Kommune, som har vist initiativ og vilje til vækst og dermed gjort noget
                        ekstraordinært for den lokale erhvervsudvikling. Prisen uddeles hvert år under ErhvervsAwards,
                        en
                    ...
                    <p>Alle studerende på Zealand - Sjællands Erhvervsakademi er i praktik i en virksomhed som en
                        del af deres uddannelse. Praktikprisen gives til den virksomhed i Slagelse kommune, som i
                        løbet af det seneste år har været praktikvirksomhed i et eller flere særligt gode praktikforløb
                    ...
                    <p>Prisen Årets Leder skal hylde et menneske, der i sin
                        ...
                        vigtigt for alle andre arbejdspladser. Vi hylder med prisen de lokale ledere, nye som erfarne på
                        små
